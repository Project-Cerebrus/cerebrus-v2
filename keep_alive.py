...
import cogs.fun.marry as marry
from discord.ext.commands import AutoShardedBot
from cogs.games.economy import get_bank_data, open_account
bot = AutoShardedBot(shard_count=10,command_prefix="!", intents = discord.Intents.all())
...
async def login():
	specialremarks = "Welcome to Cerebrus Login(Beta)"
	...
	if request.method == 'POST':
		...
		if str(usr) in login:
			...
			with open('data/users.json', 'r') as f:
					users = json.load(f)
			try:
				with open("data/devs.json") as de:
					devs = json.load(de)
				id = login[usr]["id"]
				if id in devs["devs"]:
					specialremarks = "You are a developer of this bot :)"
			except KeyError:
				return "This will not be accessible until using <p> login using Cerebrus bot"
			try:
		...
		<head>
			...
			<!-- Page Title -->
			<title>Cerebrus</title>
			


			<!-- Compressed Styles -->
			<link href="/static/css/slides.min.css?41331" rel="stylesheet" type="text/css">
			...
			<!-- Compressed Scripts -->
			<script src="/static/js/slides.min.js?41331" type="text/javascript"></script>
			...
			<div class="sections desktop">
				...
				<div class="center">
					<ul class="menu uppercase">
						<li><a href="https://Cerebus.ace6002.repl.co/">Home</a></li>
						<li><a href="https://Cerebus.ace6002.repl.co/commands">Commands</a></li>
						<li><a href="https://Cerebus.ace6002.repl.co/cstats">Covidstats</a></li>
						<li><a href="https://Cerebus.ace6002.repl.co/login">Login</a></li>
						<li><a href="https://discord.com/api/oauth2/authorize?client_id=829241822278058025&permissions=8&scope=bot%20applications.commands">Invite</a></li>
					</ul>
				</div>
				<div class="right">
					<ul class="menu trim">
				...
				<div class="container">
					<div class="wrap">
						...
						<div class="fix-12-12">
							...
							<p class="ae-3"><span class="opacity-8">Your profile</b></span></p>
							<p class="ae-3"><span class="opacity-8">Wallet : {wallet_amt}</b></span></p>
							<p class="ae-3"><span class="opacity-8">Level: {lvl}</b></span></p>
							<p class="ae-3"><span class="opacity-8">Exp: {exp}</b></span></p>
							<p class="ae-3"><span class="opacity-8">Partner:  {partner}</b></span></p>
							<p class="ae-3"><span class="opacity-8">Message:  {specialremarks}</b></span></p>
							</form>
						</div>
		...
		"""
			...
			with open("data/login/login.json","w") as z:
				json.dump(login,z)
			return f"Signed up, your login details are {usr} and {pwd}, you will not be able to use this with the bot until you link your id to it"
...
@app.route("/cerebrus_stats/",methods=["GET","POST"])
def cerebrus_stats():
		servers = len(bot.guilds)
		users = 0
		for guild in bot.guilds:
			users += len(guild.members)
		return f"""Cerebrus stats
		<h4><b>Ping: {round(bot.latency*1000)} ms</b></h4>
		<h4><b>Servers: {servers}</b></h4>
		<h4><b>Users: {users}</b></h4>"""
	

@app.route("/cstats/",methods=["GET","POST"])
def cstats():
	datez = request.args.get('date')
	if datez != None:
		url = "https://covid-193.p.rapidapi.com/history"

		querystring = {"country":"usa","day":datez}
				...
				<div class="container">
					<div class="wrap">
						...
						<div class="fix-12-12">
							...
							<p class="ae-3"><span class="opacity-8">{country}'s CovidStats</b></span></p>
							<p class="ae-3"><span class="opacity-8">Recovered : {rec}</b></span></p>
							<p class="ae-3"><span class="opacity-8">Deaths: {ded}</b></span></p>
							<p class="ae-3"><span class="opacity-8">Confirmed Cases: {conf}</b></span></p>
							<p class="ae-3"><span class="opacity-8">Last Checked:  {lc}</b></span></p>
							<p class="ae-3"><span class="opacity-8">Result:  {success}</b></span></p>
							</form>
						</div>
	...
	<html lang="en" dir="ltr">
		...
		<body>
			<form method = "POST" class="container">
				<h1>Covidstats search</h1>
				<div><label>Country <input type="text" name="country"></label></div>
				<div><label>Date (optional) <input type="text" name="date"></label></div>
